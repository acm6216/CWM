...
enum class Logo(
    ...
    CANNON(R.string.label_canon, R.drawable.logo_canon),
    ...
    CHINESE_NEW_YEAR3(R.string.label_long_year,R.drawable.tz_long,true,8),
    CHINESE_NEW_YEAR4(R.string.label_long_year,R.drawable.tz_long_1,false,8);
    ...
    fun getNumberOfIcons(): Array<Logo> = Logo.values()
}